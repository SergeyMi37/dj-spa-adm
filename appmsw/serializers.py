...
class ParamSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'json', 'value', 'creation_date', 'user', 'public', 'enabled', 'comments'
        ]
...
class SysOptionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'category', 'desc', 'option',
            'json', 'value', 'creation_date', 'user', 'public', 'enabled'
        ]
        read_only_fields = ['creation_date', 'user']
...
class DbConnectionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DbConnection
        fields = [
            'id', 'name', 'database_type', 'connection_string',
            'username', 'password', 'description', 'is_active',
            'created_date', 'updated_date', 'user'
        ]
        read_only_fields = ['created_date', 'updated_date', 'user']